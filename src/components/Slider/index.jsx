    ...
    <>
      <Splide aria-label="My Favorite Images">
        <SplideSlide>
          <div className="item">
            <div className="slider-img">
              <img src="../public/assets/images/slider_1.jpg" alt="Image 1" />
            </div>
              ...
              <div className="row">
                <div className="col-lg-5 col-md-8 col-sm-6 col-xs-12">
                  <div className="slider-captions">
                    ...
                    <img src="../public/assets/images/mi_logo.png" alt=""/>
                    </div>
                    ...
                    <Link to={"#"} className="btn btn-primary btn-lg hidden-xs">
                      Buy Now
                    </Link>
                  </div>
                </div>
        ...
        <SplideSlide>
          <div className="item">
            <div className="slider-img">
              <img src="../public/assets/images/slider_2.jpg" alt="Image 1" />
            </div>
            <div className="container">
              <div className="row">
                <div className="col-lg-5 col-md-8 col-sm-6 col-xs-12">
                  <div className="slider-captions">
                    <div className="brand-img">
                    <img src="../public/assets/images/google_logo.png" alt=""/>
        ...
        <SplideSlide>
          <div className="item">
            <div className="slider-img">
              <img src="../public/assets/images/slider_3.jpg" alt="Image 1" />
            </div>
            <div className="container">
              <div className="row">
                <div className="col-lg-5 col-md-8 col-sm-6 col-xs-12">
                  <div className="slider-captions">
                    <div className="brand-img">
                    <img src="../public/assets/images/apple_logo.png" alt=""/>
                    </div>
